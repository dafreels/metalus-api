...
class AwsProvider extends BaseProvider {
  ...
  extractCredentials(providerInstance, user) {
    return {
      accessKeyId: MetalusUtils.decryptString(providerInstance.credentials.accessKeyId || providerInstance.credentials.awsKey,
        MetalusUtils.createSecretKeyFromString(user.secretKey)),
      secretAccessKey: MetalusUtils.decryptString(providerInstance.credentials.secretAccessKey || providerInstance.credentials.awsSecret,
        MetalusUtils.createSecretKeyFromString(user.secretKey))
    };
  }
